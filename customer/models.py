...
class Profile(models.Model):
    picture = models.ImageField( db_column='Image',blank=True, null=True, help_text='Select a profile picture',upload_to='profiles/images/', default="/media/products/images/a68924_9c96bfe7821a45f391444d6f903809b9mv2.jpeg")
