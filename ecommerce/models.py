...
class Product(models.Model):
    ...
    pic = models.ImageField(db_column='Image', blank=True, null=True, help_text='Select a picture for the product', upload_to="products/images/", default="/products/images/img_default.jpeg")
